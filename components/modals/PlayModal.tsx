...
const PlayModal = () => {
    return <div className='w-full flex flex-col text-fontgrey text-sm gap-4'>
        ...
        <div className="w-full flex flex-col 2xmd:flex-row justify-between gap-2">
            <div className="flex text-white text-sm px-[16px] py-[8px] bg-[#050209]/[0.97] rounded-[12px] gap-2 2="><img src="/img/heart.svg" alt="" />50 Points per like</div>
            ...
            <div className="flex text-white text-sm px-[16px] py-[8px] bg-[#050209]/[0.97] rounded-[12px] gap-2"><img src="/img/refresh.svg" alt="" />70 Points per Quote</div>
        </div>
