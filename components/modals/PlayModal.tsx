const PlayModal = () => {
    return <div className='w-full flex flex-col text-fontgrey text-sm gap-4'>
        ...
        <div className="w-full flex flex-col md:flex-row justify-between gap-2">
            <div className="flex text-white text-sm px-[16px] py-[8px] bg-[#050209]/[0.97] rounded-[12px] gap-2"><img src="/img/heart.svg" alt="" />20 Points per like</div>
            <div className="flex text-white text-sm px-[16px] py-[8px] bg-[#050209]/[0.97] rounded-[12px] gap-2"><img src="/img/reply.svg" alt="" />30 Points per reply</div>
            <div className="flex text-white text-sm px-[16px] py-[8px] bg-[#050209]/[0.97] rounded-[12px] gap-2"><img src="/img/refresh.svg" alt="" />50 Points per retweet</div>
        </div>
